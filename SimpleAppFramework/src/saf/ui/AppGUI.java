...
public class AppGUI implements AppStyleArbiter {
    ...
    //HW4
        protected FlowPane mainToolbarPane;
    ...
    private void initWindow() {
        ...
        //HW4 - add the filetoolbarpane to the maintoolbarpain
        //HW4 - I wanted to put the buttons in a file toolbar within the main toolbar so that there is room for the edit toolbar
        mainToolbarPane.getChildren().addAll(fileToolbarPane);
        appPane.setTop(mainToolbarPane);
	...
	mainToolbarPane.getStyleClass().add(CLASS_BORDERED_PANE);
